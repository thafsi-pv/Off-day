...
const CalendarView: React.FC<{
    ...
    useEffect(() => {
        if (selectedDate) {
            ...
            if (newFocused.getUTCMonth() !== viewDate.getUTCMonth() || newFocused.getUTCFullYear() !== viewDate.getUTCFullYear()) {
                setViewDate(new Date(Date.UTC(newFocused.getUTCFullYear(), newFocused.getUTCMonth(), 1)));
            }
        }
    ...
    const { dateRange } = useMemo(() => {
        ...
        const getMaxDate = (currentConfig: Config) => {
            ...
            switch (currentConfig.weekRange) {
                ...
                case '1_MONTH': maxDate.setUTCFullYear(today.getUTCFullYear(), today.getUTCMonth() + 1, 0); break;
            }
